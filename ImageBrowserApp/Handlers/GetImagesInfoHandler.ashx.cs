...
namespace ImageBrowserApp.Handlers
{
    ...
    public class DrawImagesHandler : IHttpHandler
    {
        ...
        void DecodeImageInformation(HttpContext context, ImageInfo imageInfo)
        {
            context.Server.HtmlDecode(imageInfo.Name);
            context.Server.HtmlDecode(imageInfo.Description);
        }
        ...
        public void ProcessRequest(HttpContext context)
        {
          ...
          stringBuilder.Append("[");
            ...
            for (int i = 0; i < imageInfoList.Count; i++)
            {
                ...
                {
                    DecodeImageInformation(context, imageInfoList[i]);
